...
class Allowance:
  def __init__(self, name):
    self.name = name
    self.percentage = 0.0  # Initialize percentage attribute

  def set_percentage(self):
    self.percentage = float(input(f"Enter your {self.name} percentage: ")) / 100

  def get_allowance(self, BasicPay):
    # Calculate total allowance based on percentage and base value
    return BasicPay * self.percentage
...
obj8=Allowance("Other_HouseRentAllowances")                             
obj8.set_percentage() 

obj9=Allowance("Other_mobile_allowances")
obj9.set_percentage() 

obj10=Allowance("Other_conveyance_allowances")
obj10.set_percentage() 

obj11=Allowance("Other_ltc")
obj11.set_percentage() 
...
+obj9.get_allowance(BasicPay)
+obj10.get_allowance(BasicPay)
+ obj11.get_allowance(BasicPay)
+obj12.get_allowance(BasicPay)
...
# class Other_HouseRentAllowances(Allowance):
#     pass  
...
NetIncome.setnetincome(
    obj1.getBasicPay(),
    total_allowances(obj2.get_allowance(BasicPay),obj8.get_allowance(BasicPay),
    obj9.get_allowance(BasicPay),
    obj10.get_allowance(BasicPay),
    obj11.get_allowance(BasicPay),
    obj12.get_allowance(BasicPay)),
